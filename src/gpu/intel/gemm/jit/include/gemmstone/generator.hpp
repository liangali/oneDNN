...
protected:
    ...
    void gemmDequantizeOperation(bool doA, Type T, Type Tq, const RegisterLayout &layout, const RegisterLayout &slayout, const RegisterLayout &olayout, const GRFMultirange &regs, const GRFMultirange &sregs, const GRFMultirange &oregs, int h, int kab_load, int kq_load, const GEMMProblem &problem, const CommonStrategy &strategy, CommonState &state);
